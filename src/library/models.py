...
class Paradata(models.Model):
    ...
    @classmethod
    def reading_books_for_period_student(cls, period: Period, days=0, sort='name', username=None):
        """
    ...
    @classmethod
    def reading_data_for_period_student(cls, period: Period, days=0, sort='name', username=None):
        """
        Perform further calculation based on reading_books_for_period_student() by moving low-time books
        ...
        :return: a list of {clusive_user: u, book_count: n, total_time: t, books: [bookinfo, bookinfo,...] }
        """
        books_for_students = cls.reading_books_for_period_student(period, days, sort, username)
